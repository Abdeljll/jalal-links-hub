  ...
  const portfolios = [
    {
      ...
      description: t('portfolio.v2.description'),
    ...
    },
    {
      ...
      description: t('portfolio.v1.description'),
        ...
        <div className="relative container mx-auto px-6 py-20">
          <div className="max-w-6xl mx-auto text-center">
            <div className="inline-flex items-center gap-3 px-6 py-3 bg-gradient-accent rounded-full mb-8 shadow-green animate-fade-in">
              ...
              <span className="text-lg font-bold text-accent-foreground">{t('header.available')}</span>
